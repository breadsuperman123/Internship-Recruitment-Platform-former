    ...
    <div ref="contentContainer" class="layout-container">
      <div class="block">
        ...
        <div v-if="eduControl.condition">
          <div v-for="(edu, index) in eduInfo" :key="index">
            <a-card style="width: 600px">
              ...
              <!-- 在校时间和学历 -->
              <p> {{ formatDate(edu.startDate) || '未填写' }} —— {{ formatDate(edu.endDate) || '未填写' }}|
                {{ edu.education || '未填写' }}</p>
              <!-- 主修课程描述 -->
        ...
        <div class="form-container" v-if="!eduControl.condition">
          <a-form :model="eduInfo" :label-col="labelCol" :wrapper-col="wrapperCol" v-if="!eduControl.condition"
                  @submit.prevent="saveEduInfo">
            <a-row>
              <a-col :span="12">
            ...
            <a-row>
              <a-col :span="24">
                <a-form-item label="主修课程描述">
                  <a-textarea v-model:value="eduInfo[eduControl.index].lessonDescription"
                              placeholder="请简要描述您的主修课程" :rows="4"/>
    ...
    <div ref="contentContainer" class="layout-container">
      <div class="block">
        ...
        <div class="form-container" v-if="!practiceControl.condition">
          <a-form :model="practiceInfo" :label-col="labelCol" :wrapper-col="wrapperCol"
                  v-if="!practiceControl.condition" @submit.prevent="savePracticeInfo">
            <a-row>
              <a-col :span="12">
    ...
    <div ref="contentContainer" class="layout-container">
      <div class="block">
        ...
        <div v-if="organizationControl.condition">
          <div v-for="(organization, index) in organizationInfo" :key="index">
            <a-card style="width: 600px">
              ...
              <!-- 经历时间 -->
              <p>{{ formatDate(organization.startDate) || '未填写' }} —— {{
                  formatDate(organization.endDate) || '未填写'
                }}</p>
              <!-- 主要工作描述 -->
        ...
        <div class="form-container" v-if="!organizationControl.condition">
          <a-form :model="organizationInfo" :label-col="labelCol" :wrapper-col="wrapperCol"
                  v-if="!organizationControl.condition" @submit.prevent="saveOrganizationInfo">
            <a-row>
              <a-col :span="12">
            ...
            <a-row>
              <a-col :span="24">
                <a-form-item label="工作内容">
                  <a-textarea v-model:value="organizationInfo[organizationControl.index].jobContent"
                              placeholder="请简要描述您的社团工作经历" :rows="4"/>
                </a-form-item>
              </a-col>
            </a-row>
            <a-form-item :wrapper-col="{ span: 14, offset: 4 }">
    ...
    <div ref="contentContainer" class="layout-container">
      <div class="block">
        ...
        <div class="form-container" v-if="!projectControl.condition">
          <a-form :model="projectInfo" :label-col="labelCol" :wrapper-col="wrapperCol" v-if="!projectControl.condition"
            ...
            <a-row>
              <a-col :span="24">
                <a-form-item label="工作内容">
                  <a-textarea v-model:value="projectInfo[projectControl.index].jobContent"
                              placeholder="请简要描述您的项目工作" :rows="4"/>
                </a-form-item>
              </a-col>
            </a-row>
            <a-form-item :wrapper-col="{ span: 14, offset: 4 }">
    ...
    <div ref="contentContainer" class="layout-container">
      <div class="block">
        ...
        <div class="form-container" v-if="!certificateControl.condition">
          <a-form :model="certificateControl" :label-col="labelCol" :wrapper-col="wrapperCol"
                  @submit.prevent="saveCertificateInfo">
            <a-row>
              <a-col :span="12">
